...
class CategoriaDAO
{
    ...
    {
        // Se sua classe Conn for estática ou retornar PDO por método, ajuste aqui
        $this->conn = new Conn(); 
    }
